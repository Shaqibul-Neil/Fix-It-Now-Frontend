...
const TimeStepper = ({
  ...
  <div className="flex h-7 min-w-0 lg:flex-1 items-center justify-between gap-0.5 rounded-md bg-project-muted/40 px-0.5">
    <button
      type="button"
    ...
    <span
      ...
      className="shrink-0 rounded-md px-2 lg:px-1 text-center text-sm font-semibold tabular-nums text-project-accent outline-none focus-visible:ring-2 focus-visible:ring-project-primary/30"
    >
      {text}
    </span>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex flex-col lg:flex-row h-auto lg:h-9 min-w-0 lg:min-w-64 items-center gap-1 rounded-md border border-project-border bg-project-card p-1 aria-invalid:border-project-destructive"
      >
        <TimeStepper
